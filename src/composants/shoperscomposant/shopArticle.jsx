...
export const ShopArticles = () => {
  const { listeDesProduits, filtreur } = useGlobalContext();
  ...
  return (
    <div className="bg-black flex flex-col gap-3 h-full px-2 py-2 text-white w-[73%] border rounded-xl">
      ...
      <ul className="  h-full overflow-y-auto grid grid-cols-3 gap-4 ">
